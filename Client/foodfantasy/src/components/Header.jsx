...
import { Banner1, Banner2, Banner4, Banner5 } from "../images";

const images = [Banner1, Banner2, Banner4, Banner5];
const Header = ({ title, image, type }) => {
    return (
        <div className='w-full h-[100vh]'>
            <div className='relative w-full h-full'>
                <img src={image ?? images[Math.floor(Math.random() * images.length)]} alt='Hero Image'
                    ...
                    {
                        type && (
                            <p className='text-sm mt-4 text-center text-green-500 bg-[#00000090] px-6 py-4 rounded-full '>Welcome to FoodFantacy, your passport to culinary adventures!
